...
typedef enum {
    ...
    ERR_LOG_PERSIST_DIR_OPEN_FAIL = -12,
    ERR_LOG_PERSIST_COMPRESS_INIT_FAIL = -13,
    ERR_LOG_PERSIST_FILE_OPEN_FAIL = -14,
    ERR_LOG_PERSIST_MMAP_FAIL = -15,
    ERR_LOG_PERSIST_JOBID_FAIL = -16,
    ERR_DOMAIN_INVALID = -17,
    ERR_MEM_ALLOC_FAIL = -18,
    ERR_MSG_LEN_INVALID = -19,
    ERR_PROPERTY_VALUE_INVALID = -20,
    ERR_LOG_CONTENT_NULL = -21,
    ERR_COMMAND_NOT_FOUND = -22,
    ERR_FORMAT_INVALID = -23,
    ERR_COMPRESS_FAIL = -24,
    ERR_PERSIST_INFO_OPEN_FAIL = -25,
    ERR_FLOWCONTROL_CONF_OPEN_FAIL = -26
} ErrorCode;
