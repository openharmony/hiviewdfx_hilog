...
public:
    static constexpr std::string_view INPUT_SOCKET_NAME_SV = INPUT_SOCKET_NAME;
    HilogInputSocketClient() : DgramSocketClient(INPUT_SOCKET_NAME_SV.data(), INPUT_SOCKET_NAME_SV.length(),
